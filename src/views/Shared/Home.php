...
<div class="bg-indigo-900 justify-center mx-6 my-6 rounded-xl sm:py-32">
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-4xl text-center">
      <h3 class="text-base font-semibold leading-7 text-indigo-300">St Marys Wollaton Park:</h3>
      <p class="mt-2 text-4xl font-bold tracking-tight text-gray-100 sm:text-5xl">Evangelical Anglican Church</p>
    </div>
