...
<div class="bg-indigo-900 justify-center mx-6 my-6 rounded-xl sm:py-16">
  ...
  <div class="text-center px-6">
    ...
    <p class="mt-2 text-4xl font-bold tracking-tight text-gray-100 sm:text-5xl">Giving</p>
  </div>

  <iframe class="px-6 py-6" frameborder="0" height="1000" scrolling="yes" allowtransparent="yes" src="https://demo.churchsuite.com/donate" style="border-width:0" width="100%"></iframe>
